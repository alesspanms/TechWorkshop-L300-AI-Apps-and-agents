...
import time
from opentelemetry.instrumentation.openai_v2 import OpenAIInstrumentor          #this and line 26 enables details about the responses that were received, or detailed information on duration, tokens, and estimated cost
